...
class Asistencias {
    ...
    factory Asistencias.fromMap(Map<String, dynamic> json) => Asistencias(
        ...
        estado: json["estado"],
        programacionAcademica: ProgramacionAcademica.fromMap(json["programacionAcademica"]),
    );
...
class Role {
    ...
    factory Role.fromMap(Map<String, dynamic> json) => Role(
        id: json["id"],
        name: json["name"],
        permissions: List<Dia>.from(json["permissions"].map((x) => Dia.fromMap(x))),
    );
...
class FacultadGestion {
    ...
    factory FacultadGestion.fromMap(Map<String, dynamic> json) => FacultadGestion(
        ...
        fechaImportantes: List<FechaImportante>.from(json["fechaImportantes"].map((x) => FechaImportante.fromMap(x))),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "fechaImportantes": List<dynamic>.from(fechaImportantes.map((x) => x.toMap())),
    };
}
